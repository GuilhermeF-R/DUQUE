...
navegador.get("https://www.tempo.com/xerem.htm")
temperatura = navegador.find_element('xpath', '//*[@id="estado-actual"]/div[1]/span/span[2]/span[1]/span/span/span[1]')
...
navegador.get("https://www.fundec.rj.gov.br/noticias.php?pgs=1")

resgateTituloNews2_texto = navegador.find_element('xpath', '/html/body/div/section[2]/div/div[1]/div[2]/p/b').text
...
def telaPrincipal():
    def clima():
        ...
        def abrirClima():
            webbrowser.open(url='https://www.tempo.com/rio-de-janeiro_rio-de-janeiro-l12987.htm')
        ...
        temperaturaLabel = Label(clima, text=f"{temperaturaTexto}C", bg="#285070", fg="white", font=("Helvetica", 28))
